...
@include ('member.layout.menu')
        <div class="content">
            <div class="content-header">
                <span>報價</span> &gt; <span>項目9 運費</span> &gt; <label>新增</label>
            </div>
            <form method='post' action='/quote/create/sub9/{{ $mainId }}' class='form1' enctype="multipart/form-data">
                ...
                <div class="show-line2">
                    ...
                    <p>
                        <select name="formula">
                            <option value="1">公式 1</option>
                            <option value="2">公式 2</option>
                            <option value="3">公式 3</option>
                            <option value="4">公式 4</option>
                        </select>
                    </p>
                </div>
                <div class="show-line2">
                    <h5>運費</h5>
                    <p> <input type="number" name="freight" required /> </p>
                </div>
