...
@include ('member.layout.menu')
        <div class="content">
            <div class="content-header">
                <span>報價</span> &gt; <span>項目7-1 工序工時說明（固定委外）</span> &gt; <label>新增</label>
            </div>
            <form method='post' action='/quote/create/sub7-1/{{ $mainId }}' class='form1' enctype="multipart/form-data">
                ...
                <div class="show-line2">
                    ...
                    <p>
                        <select name="outOrSelf">
                            <option value="1">委外</option>
                            <option value="2">自製</option>
                        </select>
                    </p>
                </div>
                <div class="show-line2">
