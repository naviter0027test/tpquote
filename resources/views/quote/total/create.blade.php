...
@include ('member.layout.menu')
        <div class="content">
            <div class="content-header">
                <span>報價</span> &gt; <span>項目10 總費用計算</span> &gt; <label>新增</label>
            </div>
            <form method='post' action='/quote/create/total/{{ $mainId }}' class='form1' enctype="multipart/form-data">
                ...
                <div class="show-line2">
                    <h5>報價單價</h5>
                    <p> <input type="number" name="quotePrice" step="0.01" required readonly /> </p>
                </div>
                <div class="show-line2">
                    <h5>審核填表人</h5>
                ...
                <div class="show-line2">
                    <h5>總經理初審核</h5>
                    <p> <input type="text" name="reviewGeneralManager" /> </p>
                </div>
                <div class="show-line2">
                    <h5>總經理初審核日期</h5>
                    <input type="hidden" name="reviewGeneralManagerFillDate" />
                    <p> <input type="date" name="reviewGeneralManagerFillDateInput" /> </p>
                </div>
                <div class="show-line2">
                    <h5>總經理最終審核</h5>
                    <p> <input type="text" name="reviewFinalGeneralManager" /> </p>
                </div>
                <div class="show-line2">
                    <h5>總經理最終審核日期</h5>
                    <input type="hidden" name="reviewFinalGeneralManagerFillDate" />
