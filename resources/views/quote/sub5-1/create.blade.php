...
@include ('member.layout.menu')
        <div class="content">
            <div class="content-header">
                <span>報價</span> &gt; <span>工序總表</span> &gt; <label>新增</label>
            </div>
            <form method='post' action='/quote/create/sub5-1/{{ $mainId }}' class='form1' enctype="multipart/form-data">
